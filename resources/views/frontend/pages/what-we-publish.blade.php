...
@section('title') What we Publish @endsection
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="common-banner__content text-center">
                <h2 class="title-animation">What we Publish</h2>
            </div>
        </div>
    </div>
    <div class="banner-bg">
            ...
            <div class="col-12 col-lg-7">
                <div class="difference-three__content">
                    <div class="section__content">
                        ...
                        <h2 class="title-animation">Scope and Publication.<br>
                        </h2>
                        <p class="home3"> Anikrishna Shodh Darpan </p>
                        <p class="home2"> <strong>Publishes</strong> original research papers, review articles,
                            conceptual
                            papers, case studies,
                        </p>
                        <p class="home2">and
