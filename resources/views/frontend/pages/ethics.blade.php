...
@section('title') Publication Ethics @endsection
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="common-banner__content text-center">
                <h2 class="title-animation">Publication Ethics</h2>
            </div>
        </div>
    </div>
    <div class="banner-bg">
            ...
            <div class="col-12 col-lg-7">
                <div class="difference-three__content">
                    <div class="section__content">
                        ...
                        <h2 class="title-animation"> Publication Ethics
                        </h2>

                        <p class="home2">AKSD strictly follows international publication ethics, including:<br>
                            ● COPE-aligned ethical guidelines<br>
                            ● Zero tolerance for plagiarism<br>
                            ● Clear authorship responsibility<br>
                            ● Conflict of interest disclosure<br>
                            ● Transparent editorial decision-making<br>
