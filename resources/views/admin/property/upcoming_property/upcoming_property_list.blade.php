...
@section('title', 'Upcoming Property')
@section('content')
                    ...
                    <div class="ms-sm-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active fw-normal" aria-current="page">Upcoming Property</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header d-flex justify-content-between align-items-center">
									<h5 class="mb-0">Upcoming Property</h5>
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<div id="user-table">
											@include('admin.property.upcoming_property.upcoming_property_table_ajax', ['upcoming_property_list' => $upcoming_property_list])
										</div>
									</div>
...
<script>
 ...
 function fetchPropertyFeatures(page = 1) {
		...
		$.ajax({
            url: "{{ route('admin.fetchupcomingPropertyList') }}?page=" + page,
            method: "GET",
            data: {
                property_type,
                search
